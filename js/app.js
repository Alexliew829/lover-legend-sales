...
document.getElementById("monthPicker").value=monthISO();document.getElementById("yearPicker").value=currentYear();document.getElementById("saleDate").value=todayISO();document.getElementById("fairStart").value=todayISO();document.getElementById("fairEnd").value=todayISO();renderFairLocationOptions();renderFairLocationOptions();
