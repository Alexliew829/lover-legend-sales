...
async function saveDailySales(){
  ...
  if(typeof dispatchKeepalive==="function")dispatchKeepalive({
    ...
    company:c,
    amount:a,
    clientUpdatedAt:localRow.clientUpdatedAt,
    notifyInline:"1",
    clientVersion:"19.2"
  });
...
let systemState={currentMonth:monthISO(),closedMonths:[],commissionSnapshots:{},dataVersion:"1902"};
...
function applySystemState(state){if(state){systemState.currentMonth=state.currentMonth||monthISO();systemState.closedMonths=Array.isArray(state.closedMonths)?state.closedMonths:[];systemState.commissionSnapshots=state.commissionSnapshots||{};systemState.dataVersion=state.dataVersion||"1902"}updateReadOnlyMode()}
