...
// V46.9: the read-only health endpoint is advisory only. A slow health scan must
...
// V46.9: expose only the currently visible Sales/Fair/Live business context to
