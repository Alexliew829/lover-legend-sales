...
// V39.3: pending rows are durable retry instructions, not proof that the cloud
...
async function loadFromSheet(options = {}) {
  ...
  cloudLoadPromise = (async () => {
    ...
    try {
      ...
      // V39.3: never let the startup sync terminate at the lightweight revision
      ...
      // V39.3: verify durable pending rows against their own authoritative
...
async function syncPendingRows() {
  ...
  try {
    ...
    // V39.3: every retry path (startup, timer, focus, manual recovery) first
...
/* ================= V39.3 Fair/Live turnover entry details ================= */
