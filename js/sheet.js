...
function invalidateSalesCardCachesV315(){
  // V32.3: a newer sales-card revision must invalidate only in-memory/session data.
...
async function loadFromSheet(options = {}) {
  ...
  cloudLoadPromise = (async () => {
    ...
    try {
      ...
      // V32.3: foreground priority sync checks ONLY turnover and sales-card revisions.
...
// V32.3: keep already-loaded profit rollup data current when a Draft is saved.
