(() => {
  const RELOAD_FLAG = "lover_sales_sw_reloaded_v126";
  ...
  function startAutomaticRefreshAfterInitialSync() {
    ...
    // V12.6: do not fire a second check 5 seconds after startup.
  ...
  // V12.6: mobile pull-down-to-refresh. Horizontal dragging never triggers it.
