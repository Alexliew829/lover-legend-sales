(() => {
  const RELOAD_FLAG = "lover_sales_sw_reloaded_v114";
  ...
  function startAutomaticRefreshAfterInitialSync() {
    ...
    // V11.4: do not fire a second check 5 seconds after startup.
  ...
  // V11.4: mobile pull-down-to-refresh. Horizontal dragging never triggers it.
