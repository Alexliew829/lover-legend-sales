(() => {
  const RELOAD_FLAG = "lover_sales_sw_reloaded_v122";
  ...
  function startAutomaticRefreshAfterInitialSync() {
    ...
    // V12.2: do not fire a second check 5 seconds after startup.
  ...
  // V12.2: mobile pull-down-to-refresh. Horizontal dragging never triggers it.
